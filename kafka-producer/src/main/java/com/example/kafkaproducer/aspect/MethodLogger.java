package com.example.kafkaproducer.aspect;
...
public class MethodLogger {
  ...
  @Pointcut("within(@com.example.kafkaproducer.aspect.DebugLogging *)")
  ...
  private Map<String, Object> obtainMethodArguments(ProceedingJoinPoint joinPoint) {
    ...
    if (Objects.isNull(parameterNames) || Objects.isNull(parameterValues)) {
